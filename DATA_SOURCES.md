...
- **Mineral Commodity Summaries** — annual headline; confirmed live PDF archive back to 1996 at predictable URLs (`.../mineral-pubs/gold/mcs-2025-gold.pdf`, naming varies slightly pre-2008). Not yet parsed into a script — PDF-only, would need text extraction.
