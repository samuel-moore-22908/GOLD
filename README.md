...
| Path | Contents |
|---|---|
| `CLAUDE.md` | Repo workflow policy, plus project context, conventions, specification pitfalls, build order |
...
| `exploratory/` | First-pass scratch analysis — findings notes, scripts, and data; not a foundation to build on |
